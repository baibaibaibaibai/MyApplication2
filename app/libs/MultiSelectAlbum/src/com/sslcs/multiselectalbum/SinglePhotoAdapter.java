...
import com.sslcs.multiselectalbum.BitmapCache.ImageCallback;
import com.sslcs.multiselectalbum.ImageBucketAdapter.Holder;
...
public class SinglePhotoAdapter extends BaseAdapter {
	...
	public SinglePhotoAdapter(Activity act, List<ImageBucket> list) {
		this.act = act;
		dataList = list;
