...
public class AlbumHelper
{
    ...
    void buildImagesBucketList()
    {
        ...
        if (cur.moveToFirst())
        {
            ...
            do
            {
                ...
                Log.d("MyLog", _id + ", bucketId: " + bucketId + ", picasaId: "
    ...
    {
        // bug 3443(wangcheng) update 12/10 start
        tmpList.clear();
...
//        }
    ...
    public List<ImageItem> getImagesList(String bucketName) {

        for (ImageBucket item : tmpList) {
            if (item.getBucketName().equals(bucketName)) {
